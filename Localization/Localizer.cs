...
public sealed class Localizer
{
    ...
    {
        [TextKey.ChooseEquipment] = "Choose equipment",
        [TextKey.ChooseEquipmentHint] = "Click to choose equipment by name or model number.",
        [TextKey.ActorEquipmentHint] = "Click the icon to choose equipment. Right-click the icon or name to remove it.",
        [TextKey.EquipmentSearchHint] = "Name or model number (e9005 / a0177)",
        [TextKey.FavoritesOnly] = "Favorites only",
        [TextKey.FavoriteCurrentEquipment] = "Favorite current equipment",
        [TextKey.RemoveCurrentFavorite] = "Unfavorite current equipment",
        [TextKey.AddFavorite] = "Add favorite",
        [TextKey.RemoveFavorite] = "Remove favorite",
        [TextKey.UseEquipmentNumber] = "Use this model / variant",
        [TextKey.ManualEquipment] = "Custom model",
        [TextKey.EquipmentNoResults] = "No matching equipment. Change the search or favorites filter; armor can also be entered by model number below the search.",
        [TextKey.PickerSourceHint] = "Choose equipment for the source outfit, then use Apply to apply it to matching Actors.",
        [TextKey.PickerActorHint] = "Choosing equipment applies it to this Actor. Existing dyes are retained.",
        [TextKey.CloseEquipmentPicker] = "Close",
        [TextKey.FreeColor] = "Custom color",
        [TextKey.FreeColorHint] = "Click to choose any color. Right-click to remove dye.",
        [TextKey.NoDye] = "No dye",
        [TextKey.ClearFreeColor] = "Use original dye",
        [TextKey.FreeColorApplyHint] = "Use Apply to apply the source outfit. Only dyeable regions change.",
        [TextKey.PinCurrentAppearance] = "Pin current model + outfit",
        [TextKey.PinModifiedActors] = "Pin modified actors ({0})",
        [TextKey.UnpinAllActors] = "Clear all pins ({0})",
        [TextKey.PinModifiedActorsHint] = "Save the currently displayed model and outfit of every modified actor in this area, regardless of list filters. Existing pins are updated.",
        [TextKey.UnpinAllActorsHint] = "Remove all saved pins, including absent actors. Current appearances are not restored.",
        [TextKey.AppearancePinsSaved] = "Pinned: {0}. Appearance unavailable: {1}.",
        [TextKey.AppearancePinsRemoved] = "Removed {0} pins. Current appearances are unchanged.",
        ...
        [TextKey.SkippedMeshes] = "Skipped Meshes",
        ...
        [TextKey.StaticPreviewReady] = "Static 3D preview ready",
        [TextKey.Enable3DPreview] = "Enable 3D Preview",
        [TextKey.PreviewDisabled] = "3D preview is disabled in Settings.",
        ...
        [TextKey.AnyRace] = "Any race", [TextKey.AnyGender] = "Any gender", [TextKey.Male] = "Male", [TextKey.Female] = "Female", [TextKey.Adult] = "Adult", [TextKey.Child] = "Child", [TextKey.Everyone] = "Everyone", [TextKey.Old] = "Old", [TextKey.YoungNpc] = "Young NPC", [TextKey.Unknown] = "Unknown ({0})",
    ...
    private static readonly IReadOnlyDictionary<UiLanguage, IReadOnlyDictionary<TextKey, string>> Strings = new Dictionary<UiLanguage, IReadOnlyDictionary<TextKey, string>>
    {
        ...
        {
            [TextKey.ChooseEquipment] = "装備を選択",
            [TextKey.ChooseEquipmentHint] = "クリックして名前・モデル番号から装備を選択",
            [TextKey.ActorEquipmentHint] = "アイコンをクリックして装備を選択。アイコンまたは名前を右クリックして外す。",
            [TextKey.EquipmentSearchHint] = "名前・モデル番号で検索（e9005 / a0177）",
            [TextKey.FavoritesOnly] = "お気に入りのみ",
            [TextKey.FavoriteCurrentEquipment] = "現在の装備をお気に入りに追加",
            [TextKey.RemoveCurrentFavorite] = "現在の装備のお気に入りを解除",
            [TextKey.AddFavorite] = "お気に入りに追加",
            [TextKey.RemoveFavorite] = "お気に入りを解除",
            [TextKey.UseEquipmentNumber] = "この番号・Variantを使う",
            [TextKey.ManualEquipment] = "番号指定の装備",
            [TextKey.EquipmentNoResults] = "該当する装備がありません。検索内容・お気に入りの絞り込みを変更してください。装備は番号の直接指定もできます。",
            [TextKey.PickerSourceHint] = "コピー元装備を編集します。「一致するActorへ適用」で反映します。",
            [TextKey.PickerActorHint] = "選んだ装備をこのActorに適用します。現在の染色は引き継ぎます。",
            [TextKey.CloseEquipmentPicker] = "閉じる",
            [TextKey.FreeColor] = "自由色",
            [TextKey.FreeColorHint] = "クリックして自由に色を選択。右クリックで染色なし。",
            [TextKey.NoDye] = "染色なし",
            [TextKey.ClearFreeColor] = "元の染色を使う",
            [TextKey.FreeColorApplyHint] = "「一致するActorへ適用」で反映します。装備の染色可能な部分が変わります。",
            [TextKey.PinCurrentAppearance] = "現在のモデル＋装備をピン留め",
            [TextKey.PinModifiedActors] = "変更済みをピン留め ({0})",
            [TextKey.UnpinAllActors] = "全ピン解除 ({0})",
            [TextKey.PinModifiedActorsHint] = "一覧の絞り込みに関係なく、このエリアの変更済みActor全員について、現在表示中のモデルと装備を保存します。既存のピンも更新します。",
            [TextKey.UnpinAllActorsHint] = "現在いないActorも含め、保存済みのピンをすべて解除します。現在の外見は復元しません。",
            [TextKey.AppearancePinsSaved] = "{0}体をピン留めしました。外見を取得できなかったActor: {1}体。",
            [TextKey.AppearancePinsRemoved] = "{0}件のピンを解除しました。現在の外見は変わりません。",
            [TextKey.OriginalEquipment] = "\u30aa\u30ea\u30b8\u30ca\u30eb\u88c5\u5099",
            [TextKey.AppliedEquipment] = "変更後の装備",
            [TextKey.PinOutfit] = "\u88c5\u5099\u3092\u30d4\u30f3\u7559\u3081",
            [TextKey.UnpinOutfit] = "\u30d4\u30f3\u7559\u3081\u3092\u89e3\u9664",
            [TextKey.PinnedOutfit] = "\u30d4\u30f3\u7559\u3081\u4e2d",
            [TextKey.ModifiedOutfit] = "\u88c5\u5099\u5909\u66f4\u6e08\u307f",
            [TextKey.Unapplied] = "\u672a\u9069\u7528",
            ...
            [TextKey.SkippedMeshes] = "\u30b9\u30ad\u30c3\u30d7Mesh\u6570",
            ...
            [TextKey.StaticPreviewReady] = "\u9759\u6b623D\u30d7\u30ec\u30d3\u30e5\u30fc\u6e96\u5099\u5b8c\u4e86",
            [TextKey.Enable3DPreview] = "3D\u30d7\u30ec\u30d3\u30e5\u30fc\u3092\u6709\u52b9\u306b\u3059\u308b",
            [TextKey.PreviewDisabled] = "3D\u30d7\u30ec\u30d3\u30e5\u30fc\u306f\u8a2d\u5b9a\u3067\u7121\u52b9\u306b\u306a\u3063\u3066\u3044\u307e\u3059\u3002",
            [TextKey.NotUsed] = "未使用",
